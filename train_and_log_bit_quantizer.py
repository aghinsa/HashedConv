...
if __name__ == "__main__":
    ...
    train_configs = [
        TrainConfig(n_functions=64, n_bits=6, n_iter=1, model_name="resnet20"),
        TrainConfig(n_functions=64, n_bits=6, n_iter=1, model_name="resnet32"),
        TrainConfig(n_functions=64, n_bits=6, n_iter=1, model_name="resnet44"),
    ]

    for model_name, model_fn, ckpt_fn, config in zip(
        model_names, models, load_fns, train_configs
    ):
