...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv2 = HashedConv2d(
            planes, planes, kernel_size=3, stride=1, padding=1, bias=False, buckets=16
        )
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv1 = HashedConv2d(
            in_planes, planes, kernel_size=1, bias=False, buckets=16
        )
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = HashedConv2d(
            planes,
        ...
        self.bn2 = nn.BatchNorm2d(planes)
        self.conv3 = HashedConv2d(
            planes, self.expansion * planes, kernel_size=1, bias=False, buckets=16
        )
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.conv1 = HashedConv2d(
            3, 64, kernel_size=3, stride=1, padding=1, bias=False, buckets=16
        )
