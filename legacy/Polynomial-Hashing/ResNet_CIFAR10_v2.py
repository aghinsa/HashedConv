...
print("Accuracy of the base network on train images: %d %%" % (train_acc))
print("Accuracy of the hashed network on train images: %d %%" % (train_acc_hash))
...
print("Accuracy of the base network on test images: %d %%" % (test_acc))
print("Accuracy of the hashed network on test images: %d %%" % (test_acc_hash))
